...
function App() {
  // Create refs for the sections you want to scroll to in App.js
  ...
  // Function to scroll to a section in App.js
  ...
  return (
    <div>
      ...
      />
      <div ref={homeRef} className='twinkling sample'>
        <div className='clouds'>
          <HeroPage />
        </div>
      </div>
      
      <div ref={aboutRef} className='twinkling sample'>
        <div className='clouds'> 
      ...
      <div ref={projectRef} className='twinkling sample'>
        <div className='clouds'> 
      ...
      <div ref={contactRef} className='twinkling sample'>
        <div className='clouds'>
          <ContactPage />   
        </div>
      </div>
